...
const Data_Nascimento = () => {
  ...
  const calcularIdade = () => {
    ...
    if (isNaN(dataNasc.getTime())) {
      setIdade('Data inválida. Formato correto: AAAA-MM-DD');
      setCategoria('');
      return;
    }
  ...
  return (
    <ImageBackground source={require('./img/wallhaven-42jm79.jpg')} style={styles.background}>
      <View style={styles.container}>
        <Text style={styles.texto_principal}>Exemplo: 1999-04-27</Text>
        <TextInput
          style={styles.input}
